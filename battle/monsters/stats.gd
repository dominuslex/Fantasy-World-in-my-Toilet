...
var default_stat_99_curve : Curve = load("res://battle/stat curves/default_stat_99_curve.tres")
var default_stat_999_curve : Curve = load("res://battle/stat curves/default_stat_999_curve.tres")
